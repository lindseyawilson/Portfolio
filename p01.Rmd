...
knitr::include_graphics("/Users/lawilson1999/Desktop/Data Science Spring 2023/Portfolio/p01/data/FirstYearProjGraph.png")
```
...
```{r import-data}
library(haven)
data <- read_sav("/Users/lawilson1999/Desktop/Data Science Spring 2023/Portfolio/p01/data/Long_HWInitialAnalysis.sav")
```
